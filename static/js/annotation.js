(function(){
  ...
  // When user changes or server run changes, wipe ALL rg_ keys for this code
  if (localStorage.getItem(k('run_id')) !== window.RUN_ID) {
    // Remove every localStorage key that starts with our namespace prefix
    const prefix = `rg_${code}_`;
    const keysToRemove = [];
