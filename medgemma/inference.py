...
def parse_args() -> Config:
	...
	# Import the central config default so CLI stays in sync with config.py
	try:
		from config import MEDGEMMA_BASE_MODEL as _default_model_id
	except ImportError:
		_default_model_id = os.environ.get("MEDGEMMA_BASE_MODEL", "google/medgemma-4b-it")
	p.add_argument("--model_id", default=_default_model_id, help="Model id/path.")
