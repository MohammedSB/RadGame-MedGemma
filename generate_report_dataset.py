...
# update these paths for your system, or set REX_METADATA / REX_TEST_METADATA env vars
REX_METADATA = os.environ.get("REX_METADATA", "<path-to-rexgradient>/metadata/train_metadata.csv")
TEST_METADATA_JSON = os.environ.get("REX_TEST_METADATA", "<path-to-rexgradient>/metadata/test_metadata.json")
